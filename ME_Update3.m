function [new_state]=ME_Update3(old, Parameters)
...
vaccination_rate=Parameters(7); % Vaccination rate
social_distancing_factor=Parameters(8); % Social distancing factor
...
% Apply vaccination
new_state(1) = new_state(1) - vaccination_rate * old(1); % Reduce susceptibles
new_state(4) = new_state(4) + vaccination_rate * old(1); % Increase recovered
